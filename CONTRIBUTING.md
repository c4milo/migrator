...
* In Github, fork `https://github.com/c4milo/migrator` to your own account
* Get the package using "go get": `go get github.com/c4milo/migrator`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/c4milo/migrator`
* Add a git remote pointing to your own fork: `git remote add downstream git@github.com:<your_account>/migrator.git`
